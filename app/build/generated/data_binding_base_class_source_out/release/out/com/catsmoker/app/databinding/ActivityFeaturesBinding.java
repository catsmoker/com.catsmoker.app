...
public final class ActivityFeaturesBinding implements ViewBinding {
  ...
  @NonNull
  public final Button btnOpenLteCleaner;
  ...
  private ActivityFeaturesBinding(@NonNull ScrollView rootView, @NonNull Button btnApplyDns,
      @NonNull Button btnOpenLteCleaner, @NonNull MaterialButton btnToggleCrosshair,
      ...
      @NonNull ImageView scope1, @NonNull ImageView scope2, @NonNull ImageView scope3,
      @NonNull ImageView scope4, @NonNull LinearLayout scopeImageContainer,
      @NonNull HorizontalScrollView scopeScrollView) {
    this.rootView = rootView;
    this.btnApplyDns = btnApplyDns;
    this.btnOpenLteCleaner = btnOpenLteCleaner;
  ...
  public static ActivityFeaturesBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.btn_open_lte_cleaner;
      Button btnOpenLteCleaner = ViewBindings.findChildViewById(rootView, id);
      if (btnOpenLteCleaner == null) {
        break missingId;
      }
      ...
      return new ActivityFeaturesBinding((ScrollView) rootView, btnApplyDns, btnOpenLteCleaner,
          btnToggleCrosshair, cardScope1, cardScope2, cardScope3, cardScope4, crosshairCard,
          dnsSpinner, featuresHeaderTitle, featuresTitle, scope1, scope2, scope3, scope4,
          scopeImageContainer, scopeScrollView);
    }
